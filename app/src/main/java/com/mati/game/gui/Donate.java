...
import com.mati.game.gui.adapters.ActionsAdapter;
import com.mati.game.gui.adapters.DonatAdapter;
import com.mati.game.gui.adapters.DonateAdapter;
import com.mati.game.gui.models.Actions;
import com.mati.game.gui.models.Donat;
import com.mati.game.gui.models.Donatee;
...
public class Donate extends AppCompatActivity {
    ...
    public void setListeners(Activity aactivity) {
        ...
        actija.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                v.startAnimation(AnimationUtils.loadAnimation(aactivity, R.anim.button_click));
                maintext.setText("تبلیغات و پیشنهادات ویژه");
                auto.setBackgroundColor(Color.parseColor("#00990055"));
                auto.setTextColor(Color.parseColor("#ff666666"));
                vips.setBackgroundColor(Color.parseColor("#00990055"));
                vips.setTextColor(Color.parseColor("#ff666666"));
    ...
    public void show_uslugi() {
        ...
        donatList.add(new Donat(1, "تغییر نام", "50", "change_nickname"));
        donatList.add(new Donat(2, "اخطار(Warn) را حذف کنید", "100", "delete_warn"));
        donatList.add(new Donat(3, "همه مجوزها", "150", "licenses"));
        donatList.add(new Donat(4, "قدرت خرید", "300", "power"));
        donatList.add(new Donat(5, "ساب و باند", "1000", "subwoofer"));
        donatList.add(new Donat(6, "اسلات اضافی ماشین", "100", "add_car_slot"));
        donatList.add(new Donat(7, "پلاک ماشین (خاص)", "85", "buy_car_number"));
        donatList.add(new Donat(8, "شماره تلفن (خاص)", "70", "phone_number"));
        setDonatRecycler(donatList);
        uslugiRecycler.setVisibility(View.VISIBLE);
        topusl.setText("تغییر نام");
...
// donateList.add(new Donatee(11, "", "", "auto_", " BC"));
    ...
    public void show_actions() {
        ...
        actionList.add(new Actions(28, "برای شما", "Nissan", "auto_skyline", 327));
        actionList.add(new Actions(54, "عمومی", "Cadilac", "auto_kadilac", 3300));
